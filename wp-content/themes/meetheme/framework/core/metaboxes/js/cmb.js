...
jQuery(document).ready(function($) {
    ...
    function portfolio_setting() {
        ...
        select_type.each(function() {
            ...
            if (($(this).attr('selected') == 'selected') && ($(this).attr('value') == 'image')) {
                $('.cmb_id_meetheme-image-gallery').hide();
                $('.cmb_id_meetheme-post-image').fadeIn();
                $('.cmb_id_meetheme-post-embed').hide();
            } else if (($(this).attr('selected') == 'selected') && ($(this).attr('value') == 'gallery')) {
                $('.cmb_id_meetheme-image-gallery').fadeIn();
                $('.cmb_id_meetheme-post-image').hide();
                $('.cmb_id_meetheme-post-embed').hide();
            } else if (($(this).attr('selected') == 'selected') && ($(this).attr('value') == 'video')) {
                $('.cmb_id_meetheme-image-gallery').hide();
                $('.cmb_id_meetheme-post-image').hide();
                $('.cmb_id_meetheme-post-embed').fadeIn();
            }
        });
    }
    portfolio_setting();
